...
const client = require('redis').createClient({ host: config.redisEndPoint, port: config.redisPort, password: "TEMPBT786khgbvgf896Bhgff4ffdvb_gyujht6htc76", no_ready_check: true })
